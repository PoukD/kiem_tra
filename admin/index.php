    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <a class="nav-link active" href="<?php echo SITEURL.'admin/add-employee.php'?>">Thêm Cán Bộ</a>
                </li>
                ...
                <li class="nav-item">
                    <a href="" class="btn btn-primary nav-link active loc">Lọc</a>
                </li>
            </ul>
            <form class="d-flex">
        ...
        <main>
            ...
            <table class="table">
                <thead class="">
                    ...
                    <td scope="col"><b>Điện Thoại Di Động</b></td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo SITEURL; ?>admin/update-employee.php?id=<?php echo $id; ?>"><i class="bi bi-pencil-fill"></i></a></td>
                        <td><a href="<?php echo SITEURL; ?>admin/delete-employee.php?id=<?php echo $id; ?>"><i class="bi bi-archive-fill"></i></a></td>
                    </tr>
                    <?php
                            $i++;
                            }
