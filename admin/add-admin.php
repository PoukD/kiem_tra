        ...
        <div class="wrapper add-admin">
                ...
                <form action="" method="POST">
                    ...
                    <table class="tbl-30" id="tbInsertData">
                        ...
                        <tr>
                            <td>
                                <input type="text" name="username" id="txtUsername"class="addtxt" placeholder="Enter Username">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="email" name="email" id="txtEmail"class="addtxt" placeholder="Enter Email">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="password" name="password"id="txtPass" class="addtxt"placeholder="Enter Password">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
